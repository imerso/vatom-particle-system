    ...
    onPSFire1Press() {
        ...
        this.user.getPosition().then((pos) =>
        {
            this.objects.create({
                ...
                particle_direction1_y: 0.1,
                particle_direction1_z: 0,
                particle_direction2_x: 0,
                particle_direction2_y: 0.15,
                particle_direction2_z: 0,
                particle_min_box_x: -0.1,
                particle_min_box_y: -0.1,
                particle_min_box_z: -0.1,
                particle_max_box_x: 0.1,
                particle_max_box_y: 0.1,
                particle_max_box_z: 0.1,
    ...
    onPSFire3Press() {
        ...
        this.user.getPosition().then((pos) =>
        {
            this.objects.create({
                ...
                particle_color1: '#ffffff',
                particle_color2: '#f0f0f0',
                particle_direction1_x: 0.5,
                particle_direction1_y: 1,
                particle_direction1_z: 0,
                particle_direction2_x: 0,
                particle_direction2_y: 1.5,
                particle_direction2_z: 0,
                particle_min_box_x: -0.1,
                particle_min_box_y: -0.1,
                particle_min_box_z: -0.1,
    ...
    onPSFire4Press() {
        ...
        this.user.getPosition().then((pos) =>
        {
            this.objects.create({
                ...
                particle_direction1_x: 0,
                particle_direction1_y: 0,
                particle_direction1_z: 0,
                particle_direction2_x: 0,
                particle_direction2_y: 0,
                particle_direction2_z: 0,
                particle_min_box_x: -0.1,
                particle_min_box_y: -0.1,
                particle_min_box_z: -0.1,
